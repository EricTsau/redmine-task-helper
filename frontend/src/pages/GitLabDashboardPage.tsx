            ...
            <div className="relative z-10 flex-1">
                <p className="text-sm text-muted-foreground font-medium uppercase tracking-wider flex items-center gap-1">
                    ...
                    <div className="group/info relative cursor-help">
                        ...
                        <div className="absolute left-1/2 bottom-full mb-2 -translate-x-1/2 w-48 p-2 bg-slate-900 text-slate-200 text-xs rounded-lg opacity-0 group-hover/info:opacity-100 transition-opacity pointer-events-none z-50 shadow-xl border border-white/10">
                            {description}
