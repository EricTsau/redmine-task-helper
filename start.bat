...
start "Redmine Backend" cmd /c "uvicorn app.main:app --host 127.0.0.1 --port 8000 --workers 4"
@REM start "Redmine Backend" cmd /c "uvicorn app.main:app --host 127.0.0.1 --port 8000 --reload"
